...
<head>
    ...
    <title>Reset Password - Challengify</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="col-lg-5 col-md-7">
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <!-- Reset Password Form -->
                            <form id="resetPasswordForm" action="/reset-password" method="post" class="needs-validation" novalidate>
                                <!-- CSRF Token -->
                                <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                <input type="hidden" name="token" value="<?php echo isset($_SESSION['reset_token']) ? htmlspecialchars($_SESSION['reset_token']) : htmlspecialchars($_GET['token']); ?>">
